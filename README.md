# LumieComponentInspector

## Introduction

**LumieComponentInspector** is an enhanced GameObject's components Inspector for Unity.
...
Open the window from: `Tools/LumieComponentInspector`

## Known issues

- Uncompleted non-GameObject inspecting, missing some inspector elements unlike Unity native Inspector